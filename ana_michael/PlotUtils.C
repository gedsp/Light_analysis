...
void WA105_LABEL(Double_t x,Double_t y,int font, Color_t color) 
{
  ...
  l.DrawLatex(x,y,"WA105");
}

void WA105_PRELIMINARY_LABEL(Double_t x,Double_t y,int font, Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(text_font_bold);
  l.SetTextSize(text_size);
  l.SetTextColor(color);
  l.DrawLatex(x,y,"WA105} #font[72]{PRELIMINARY}");
}

void WA105_PRELIMINARY_LABEL_RATIO(Double_t x,Double_t y,int font, Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(text_font_bold);
